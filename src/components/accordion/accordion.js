	...
	render() { 
		return ( 
				<div className="accordion">
					...
					<AccordionItem heading="Doggie" description="Dog behavior is the internally coordinated responses (actions or inactions) of the domestic dog (individuals or groups) to internal and/or external stimuli"/>
